...
const CACHE = 'pishi-v6';
const SHELL = [
  './', './index.html', './manifest.webmanifest', './icon.svg', './icon.png',
  './topics/greetings.html', './topics/colors.html', './topics/animals.html', './topics/numbers.html',
  './topics/family.html', './topics/food.html', './topics/body.html',
  './topics/clothes.html', './topics/weather.html', './topics/classroom.html',
  './topics/actions.html', './games/color-cup.html', './games/wordsearch.html', './games/crossword.html',
  './print/greetings-print.pdf', './print/colors-print.pdf', './print/animals-print.pdf', './print/numbers-print.pdf',
